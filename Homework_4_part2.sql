...
-- 1. Вывести название и цену для всех анализов, которые продавались 5 февраля 2020 и всю следующую неделю.

SELECT a.an_name, a.an_price FROM Analysis a JOIN Orders o ON o.ord_an = a.an_id WHERE ord_datetime BETWEEN "2020-02-05 00:00:00" AND "2020-02-12 23:59:59";
