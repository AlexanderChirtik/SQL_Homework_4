...
SELECT COLOR, COUNT(*) FROM AUTO WHERE MARK IN ("BMW", "LADA") GROUP BY COLOR;

-- 2. Вывести на экран марку авто и количество AUTO не этой марки

SELECT DISTINCT MARK, (SELECT COUNT(*) FROM AUTO AS A1 WHERE A1.MARK != AUTO.MARK) AS OTHER_MARKS FROM AUTO;
